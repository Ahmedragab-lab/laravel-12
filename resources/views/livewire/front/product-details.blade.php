            ...
            <div class="product-single__image">
              <div class="swiper-container">
                <div class="swiper-wrapper">
                    @if($product->images->isNotEmpty())
                        @foreach($product->images as $index => $image)
                            <div class="swiper-slide product-single__image-item">
                                <img loading="lazy" class="h-auto" src="{{ display_file('products_images/' . $image->file_name) }}" width="674" height="674" alt="Product Image" />
                                <a data-fancybox="gallery" href="{{ display_file('products_images/' . $image->file_name) }}" data-bs-toggle="tooltip"
                    ...
                    @else
                        <div class="swiper-slide product-single__image-item">
                            <img loading="lazy" class="h-auto" src="{{ $product->image ? display_file($product->image) : asset('no-image.jpg') }}" width="674" height="674" alt="No image available" />
                        </div>
                    @endif
                </div>
                        ...
                        @foreach($product->images as $index => $image)
                            <div class="swiper-slide product-single__image-item">
                                <img loading="lazy" class="h-auto"
                                    src="{{ display_file('products_images/' . $image->file_name) }}"
                                    width="104" height="104" alt="Product Thumbnail" />
                            </div>
                        @endforeach
                    @else
                        <div class="swiper-slide product-single__image-item">
                        <img loading="lazy" class="h-auto"
                        src="{{ $product->image ? display_file($product->image) : asset('no-image.jpg') }}"
                        width="104" height="104" alt="No image available" />
                        </div>
                    @endif
                </div>
              </div>
