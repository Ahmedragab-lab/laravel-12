                        ...
                        <div class="accordion-body px-0 pb-0">
                            <div class="d-flex flex-wrap">
                                @foreach ($colors as $color)
                                    <!-- {{ $color->name }} -->
                                    <a href="#" wire:click.prevent="toggleColor({{ $color->id }})"
                        ...
                        <div class="accordion-body px-0 pb-0">
                            <div class="d-flex flex-wrap">
                                ...
                                @foreach ($sizes as $size)
                                    <a href="#" wire:click.prevent="toggleSize({{ $size->id }})"
            ...
            <div class="accordion-item mb-4">
                ...
                <div id="accordion-filter-price" class="accordion-collapse collapse show border-0"
                    ...
                    <div class="price-range__inputs">
                        <input type="range" wire:model.lazy="minPrice" min="10" max="1000" step="5">
                        <input type="range" wire:model.lazy="maxPrice" min="10" max="1000" step="5">
                    </div>
                    ...
                    <div class="product-card-wrapper">
                        <div class="product-card mb-3 mb-md-4 mb-xxl-5">
                            ...
                            <div class="pc__info position-relative">
                                ...
                                <h6 class="pc__title"><a href="{{ route('product-details', $product->slug) }}">
                                ...
                                <div class="product-card__review d-flex align-items-center mt-2">
                                    ...
                                    <span
                                        class="reviews-note text-lowercase text-secondary ms-1">{{ $product->reviews_count ?? 'No' }}
                                        reviews</span>
                                </div>
