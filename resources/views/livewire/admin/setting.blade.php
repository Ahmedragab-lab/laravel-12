                ...
                <div class="row">
                        ...
                        <div class="row">
                            <div class="col-md-9">
                                <div class="form-group">
                                    <label for="logo_img" >@lang('settings.Logo_Image')</label>
                                    <input type="file" id="logo_img"  class="form-control" wire:model="logo_img"  accept="image/*">
                                    @error('logo_img')<span class="text-danger">{{ $message }}</span>@enderror
                                </div>
                            </div>
                            <div class="col-md-3">
                                @if($logo_img)
                                    <img src="{{ $logo_img->temporaryUrl() }}" width='80' alt="">
                                @else
                                    <img src="{{ display_file(setting('logo_img')) }}" width='80' alt="">
                                @endif
                            </div>
                        </div>
                    </div>
                    <div class="col-md-3">
                        <div class="row">
                            <div class="col-md-9">
                                <div class="form-group">
                                    <label for="icon_img" >@lang('settings.Browser_Icon')</label>
                                    <input type="file" id="icon_img"  class="form-control" wire:model="icon_img"  accept="image/*">
                                    @error('icon_img')<span class="text-danger">{{ $message }}</span>@enderror
                                </div>
                            </div>
                            <div class="col-md-3">
                                @if($icon_img)
                                    <img src="{{ $icon_img->temporaryUrl() }}" width='70' alt="">
                                @else
                                    <img src="{{ display_file(setting('icon_img')) }}" width='70' alt="">
                                @endif
                            </div>
                        </div>
                    </div>
